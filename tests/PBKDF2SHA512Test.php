...
class PBKDF2SHA512Test extends TestCase
{
  ...
  {
    $hasher = new Hasher\PBKDF2SHA512();
    $hash = $hasher->encode('123456', static::SALT_123456, static::ITERATION);
  ...
  {
    $hasher = new Hasher\PBKDF2SHA512();
    $hash = $hasher->encode('1234567', static::SALT_123456, static::ITERATION);
